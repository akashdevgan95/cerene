      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            CereneAI meets the highest standards for healthcare data protection
            and privacy.
          </p>
          ...
          <Card className="border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20">
            ...
            <CardContent>
              <p className="text-green-800 dark:text-green-200 text-sm text-center">
                All PHI is encrypted in transit and at rest using AES-256
                encryption
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20">
            ...
            <CardContent>
              <p className="text-blue-800 dark:text-blue-200 text-sm text-center">
                Strict role-based access controls and audit logging for all data
                access
              </p>
            </CardContent>
          </Card>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            federal law that establishes national standards for protecting
            sensitive patient health information. As a digital health platform,
            CereneAI is committed to full HIPAA compliance.
          </p>
          ...
          <ul>
            <li>
              <strong>Security Officer:</strong> Designated HIPAA security
              officer responsible for compliance oversight
            </li>
            <li>
              <strong>Workforce Training:</strong> All employees receive
              comprehensive HIPAA training
            </li>
            <li>
              <strong>Access Management:</strong> Minimum necessary access
              principles for all PHI
            </li>
            <li>
          ...
          <ul>
            <li>
              <strong>Facility Access:</strong> Secure data centers with
              biometric access controls
            </li>
            <li>
              <strong>Workstation Security:</strong> Encrypted devices and
              secure remote access protocols
            </li>
            <li>
              <strong>Media Controls:</strong> Secure disposal and reuse of
              electronic media
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Access Control:</strong> Unique user identification and
              automatic logoff
            </li>
            <li>
              <strong>Audit Controls:</strong> Comprehensive logging of all
              system access and activities
            </li>
            <li>
              <strong>Integrity:</strong> Electronic PHI protection against
              improper alteration
            </li>
            <li>
              <strong>Transmission Security:</strong> End-to-end encryption for
          ...
          <p>
            All third-party vendors who may have access to PHI sign
            comprehensive Business Associate Agreements (BAAs) that ensure HIPAA
            compliance throughout our service ecosystem.
          </p>

          <h2>Patient Rights Under HIPAA</h2>
          <p>
            As a CereneAI user, you have the following rights regarding your
            health information:
          </p>
          <ul>
            <li>
              <strong>Right to Access:</strong> Request copies of your therapy
              session records
            </li>
            <li>
            ...
            <li>
              <strong>Right to Restrict:</strong> Request limitations on how
              your PHI is used
            </li>
            <li>
            ...
            <li>
              <strong>Right to Notification:</strong> Be notified of any
              breaches affecting your PHI
            </li>
          </ul>
          ...
          <p>
            CereneAI undergoes regular third-party security audits and maintains
            SOC 2 Type II certification. Our compliance program includes:
          </p>
          <ul>
          ...
          <p>
            If you have any security concerns or suspect a potential HIPAA
            violation, please contact our security team immediately:
          </p>
          <ul>
            <li>Email: security@CereneAI.com</li>
            <li>Phone: 1-800-MINDFUL (24/7 security hotline)</li>
            <li>
              Address: HIPAA Security Officer, 123 Security Blvd, San Francisco,
              CA 94105
            </li>
          </ul>
        </div>
