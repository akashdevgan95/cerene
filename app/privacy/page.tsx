    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            When you create an account with CereneAI, we collect basic
            information such as your name, email address, and therapy
            preferences. This information is necessary to provide you with
            personalized therapy sessions.
          </p>

          <h3>Therapy Session Data</h3>
          <p>
            All conversations with our AI therapist are encrypted and stored
            securely. We use this data solely to improve your therapy experience
            and provide continuity across sessions. Your therapy data is never
            shared with third parties.
          </p>

          <h3>Usage Analytics</h3>
          <p>
            We collect anonymized usage data to understand how our service is
            used and to improve the platform. This includes session duration,
            feature usage, and technical performance metrics.
          </p>
          ...
          <ul>
            <li>
              <strong>End-to-End Encryption:</strong> All therapy conversations
              are encrypted using AES-256 encryption
            </li>
            <li>
              <strong>HIPAA Compliance:</strong> We follow strict healthcare
              data protection standards
            </li>
            <li>
              <strong>Secure Infrastructure:</strong> Our servers are hosted in
              SOC 2 compliant data centers
            </li>
            <li>
              <strong>Access Controls:</strong> Only authorized personnel can
              access systems, never your personal data
            </li>
          </ul>
          ...
          <p>
            ...
            data for research purposes to advance mental health care.
          </p>
          ...
          <p>
            ...
            agreements and can only access data necessary for their specific
            services.
          </p>
          ...
          <p>
            We retain your therapy session data for as long as your account is
          ...
          <p>
            Your data is primarily stored in secure data centers within the
            United States. If you access our service from outside the US, your
            data may be transferred to and processed in the US under appropriate
            safeguards.
          </p>
          ...
          <p>
            ...
            you of any material changes by email or through our service. Your
            continued use of CereneAI after such changes constitutes acceptance
          ...
          <ul>
            <li>Email: privacy@CereneAI.com</li>
